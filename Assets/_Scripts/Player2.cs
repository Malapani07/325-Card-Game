...
{
    [SerializeField] public List<GameObject> Player2Cards;
    public int Goal;
    public int point;
    public int loan;
    ...
    {
        int a =Random.Range(0, Player2Cards.Count);
        return Player2Cards[a];
    }
    ...
    GameObject TagChecker2throw()
    {
        ...
        {
            if (Player2Cards[i] != null && Player2Cards[i].CompareTag(thrownCard0))
            {
                selectedcards.Add(Player2Cards[i]);
            }
        }
        ...
        if (selectedcards.Count <= 0)
        {
            ...
            for (int i = 0; i < Player2Cards.Count; i++)
            {
                if (Player2Cards[i] != null && Player2Cards[i].CompareTag(trump))
                {
                    selectedcards.Add(Player2Cards[i]);
                }
            }
    ...
    GameObject TagChecker3throw()
    {
        ...
        for (int i = 0; i < Player2Cards.Count; i++)
        {
            if (Player2Cards[i] != null && Player2Cards[i].CompareTag(GameManager.instance.ThrownCard[0].tag))
            {
                selectedcards.Add(Player2Cards[i]);
            }
        }
        ...
        if (selectedcards.Count <= 0)
        {
            for (int i = 0; i < Player2Cards.Count; i++)
            {
                if (Player2Cards[i] != null && Player2Cards[i].CompareTag(GameManager.instance.trump))
                {
                    selectedcards.Add(Player2Cards[i]);
                }
            }
